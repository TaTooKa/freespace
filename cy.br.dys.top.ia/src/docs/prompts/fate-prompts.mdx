...
⋗ **When you suffer the outcome of a mechanical or narrative <span class="fuchsia">FAILURE</span>**, choose one (If you suffer a <span class="fuchsia bold">CRITICAL FAILURE</span>, make it worse or choose two):
