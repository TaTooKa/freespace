...
&nbsp;<span class="turquoise bold">⋙ SUCCESS</span>: The whole group prevails by following your lead.<br/>
then, if any of the other participants obtained a <span class="fuchsia bold">FAILURE</span>, you are _IN A BAD SPOT_ (If you already were, then you must [PAY THE CONSEQUENCES (X)](/prompts/fate-prompts#pay-the-consequences) where X is the amount of <span class="fuchsia bold">FAILURES</span>).

> If <span class="turquoise bold">CRITICAL</span>, pick one for each <span class="turquoise bold">SUCCESS</span> the other participants obtained (minimum of one):<br/>
‣ Gain (or give) a <span class="boost">BOOST</span> to a future related action<br/>
‣ [MAKE PROGRESS](/prompts/challenge-prompts#make-progress)<br/>
‣ You (or one of the other participants) are _IN CONTROL_<br/>
‣ Reduce the severity by one if you have to [PAY THE CONSEQUENCES (X)](/prompts/fate-prompts#pay-the-consequences) for an ally that failed.<br/>
...
For each <span class="fuchsia bold">FAILURE</span> the other participants obtained, choose one:
