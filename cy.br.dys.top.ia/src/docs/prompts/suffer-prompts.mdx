...
Then, **if your GRIT is 0 or you choose to resist the harm**, test your <span class="stat">CHROME</span>.

&nbsp;<span class="turquoise bold">⋙ SUCCESS</span>: You shake it off. Gain a **BOOST** for your next test. 

> If <span class="turquoise bold">CRITICAL</span>, also gain **+1 GRIT**.

&nbsp;<span class="fuchsia bold">⋙ FAILURE</span>: You are in pain. Gain a **GLITCH** for your next test. 

> If <span class="fuchsia bold">CRITICAL</span>, it’s worse than you thought. Suffer another **-1 GRIT**.

Then, **if your GRIT is still 0**, roll on the table below (if you are *IN A BAD SPOT* you gain a **GLITCH** to this roll):

| RESULT | |
| :---: | --- |
| 01-25 | You are still standing, somehow. |
| 26-40 | You are reeling. You gain a **GLITCH** to all tests for the remainder of this scene. |
...
Then, **if your PSYCHE is 0 or you choose to resist the stress**, test your <span class="stat">FLASH</span>.

&nbsp;<span class="turquoise bold">⋙ SUCCESS</span>: You shake it off. Gain a **BOOST** for your next test. 
> If <span class="turquoise bold">CRITICAL</span>, also gain **+1 PSYCHE**.

&nbsp;<span class="fuchsia bold">⋙ FAILURE</span>: You are shaken. Gain a **GLITCH** for your next test. 

> If <span class="fuchsia bold">CRITICAL</span>, it’s worse than you thought. Suffer another **-1 PSYCHE**.

Then, **if your PSYCHE is still 0**, roll on the table below (if you are *IN A BAD SPOT* you gain a **GLITCH** to this roll):
...
| 51-75 | You give in to fear or compulsion or act against your better instincts (gaining a **GLITCH** to all tests on this scene), or give up ([FAIL A CHALLENGE](/prompts/challenge-prompts#fail-a-challenge) automatically). |
...
## FACE DEATH
⋗ **When you are brought to the brink of death**, test your <span class="stat">CHROME</span>.
...
## FACE DESOLATION
⋗ **When you are brought to the brink of desolation**, test your <span class="stat">FLASH</span>.
