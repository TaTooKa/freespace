const spaceOracleResults = {
  ...
  "oracle-planet-atmosphere-result": [
    ...
    // "Toxic",
    // "Corrosive",
    "<i>Nitrogen-Oxygen</i>: Blue sky, white clouds. Possible rain, snow thunderstorms, hurricanes, etc. Flora might be green, yellow, or brown. <i>Breathable</i>.",
    "<i>Nitrogen-Helium-Oxygen</i>: Blue sky, white clouds. Possible rain, snow thunderstorms, hurricanes, etc. Flora might be green, yellow, or brown. <i>Breathable</i>.",
    "<i>Helium-Oxygen</i>: Blue sky, white clouds. Possible rain, snow thunderstorms, hurricanes, etc. Flora might be green, yellow, or brown. <i>Breathable</i>.",
    "<i>Hydrogen-Oxygen</i>: Blue sky, white clouds. Possible rain, snow thunderstorms, hurricanes, etc. Flora might be green, yellow, or brown. <i>Breathable</i>.",
    "<i>Hydrogen-Helium-Oxygen</i>: Blue sky, white clouds. Possible rain, snow thunderstorms, hurricanes, etc. Flora might be green, yellow, or brown. <i>Breathable</i>.",
    "<i>Argon-Oxygen</i>: Blue sky, white clouds. Possible rain, snow thunderstorms, hurricanes, etc. Flora might be green, yellow, or brown. <i>Barely Breathable</i>.",
    "<i>Krypton-Oxygen</i>: Blue sky, white clouds. Possible rain, snow thunderstorms, hurricanes, etc. Flora might be green, yellow, or brown. <i>Barely Breathable</i>.",
    "<i>Radon-Oxygen</i>: Blue sky, white clouds. Possible rain, snow thunderstorms, hurricanes, etc. Flora might be green, yellow, or brown. <i>Breathable, but radioactive</i>.",
    ...
    "<i>Ammonia</i>: Thick ammonia clouds. Possible cold temps, icy clouds, ammonia haze, ammonia rain, ice storms, cryovolcanism. Flora might be icy blue, pale violet, or white. <i>Corrosive, Unbreathable</i>.",
    "<i>Carbon Dioxide</i>: Pale, hazy sky. Probable dry climate due to lack of precipitation. Increased temp extremes due to greenhouse effect, dry windstorms, predictable weather patterns. Flora might be deep red or black in order to absorb more light. <i>Unbreathable</i>.",
    "<i>Carbon Dioxide-Rich</i>: Pale, hazy sky. Probable dry climate due to lack of precipitation. Increased temp extremes due to greenhouse effect, dry windstorms, predictable weather patterns. Flora might be deep red, dark green, purple, or black. <i>Unbreathable</i>.",
    "<i>Chlorine-Rich</i>: Yellowish-green sky. Highly reactive atmosphere, chemical storms, extreme turbulence. Limited liquid water due to reaction with chlorine to create hydrochloric acid. Flora might be yellow, orange, maroon, or brown. <i>Corrosive, Unbreathable</i>.",
    "<i>Fluorine</i>: Pale blue sky, faint glows. Highly reactive atmosphere, chemical storms, extreme turbulence. Limited liquid water due to reaction with Fluorine to create hydrofluoric acid. Flora might be turquoise or reddish-orange, and possibly luminescent. <i>Corrosive, Unbreathable</i>.",
    "<i>Hydrocarbon-Rich</i>: Red/orange/brown sky, perpetual haze. Possible extreme day/night temp variation, chemical storms, lightning, aerial tides. Flora might be deep red, orange, brown, or blue-green. <i>Corrosive, Highly Flammable, Unbreathable</i>.",
    "<i>Hydrogen</i>: Bluish sky, gentle winds, limited precipitation, destabilizing buoyancy. Possible day/night temp extremes, methane clouds, massive hydrogen storms, hydrogen cyclones, lightning storms. Flora might be pale blue, silver, light green, or pale orange. <i>Unbreathable</i>.",
    "<i>Hydrogen-Helium</i>: Pale blue sky, hints of pink and white, shimmering effects, destabilizing buoyancy. Possible day/night temp extremes, gentle winds, hydrogen-helium storms, periodic lightning. Flora might be pale blue, pink, or white. <i>Unbreathable</i>.",
    "<i>Hydrogen-Sulfide</i>: Pale green/yellow sky, persistent haze. Possible day/night temp extremes, acid rain, sulfurous lightning, volcanic activity, corrosive wind. Flora might be yellow, pale green, brown, or violet. <i>Corrosive, Unbreathable</i>.",
    "<i>Krypton-Methane</i>: Bluish sky, dim light, methane clouds. Possible day/night temp extremes, methane rain, methane storms, methane ice, complex weather models.  Flora might be blue, violet, indigo, or orange. <i>Highly Flammable, Unbreathable</i>.",
    "<i>Methane</i>: Reddish-brown sky, diffuse light, methane clouds. Possible day/night temp extremes, methane rain, methane storms, methane ice, complex weather. Flora might be dark brown, reddish-brown, deep green, or black, in order to absorb more light. <i>Highly Flammable, Unbreathable</i>.",
    "<i>Nitrogen</i>: Blue sky, cloud formations. Possible precipitation, wind, storms. Flora might be blue, green, cyan, or brown. <i>Unbreathable</i>.",
    "<i>Nitrogen-Methane</i>: Blue/blue-green sky, methane clouds. Possible methane precipitation, methane storms. Flora might be green, blue-green, teal, or red. <i>Unbreathable</i>.",
    "<i>Neon-Nitrogen</i>: Soft pinkish-purple sky, faint shimmers. Stable, limited weather phenomena. Flora might be soft pink, purple, lavender, or pale green. <i>Unbreathable</i>.",
    "<i>Nitrous Oxide</i>: Blue/purple sky, iridescent glows, shimmering lights. Stable, limited weather phenomena. Flora might be blue, purple, silver, or gold. <i>Unbreathable</i>.",
    "<i>Oxygen-Rich</i>: Vibrant blue sky. Possible intense weather patterns, thunderstorms, electrical storms, natural fires. Flora might be vibrant green, deep red, or orange. <i>Breathable, Highly Flammable</i>.",
    "<i>Silane-Rich</i>: Hazy, pale orange sky. Possible day/night temp extremes, silicate dust storms, acid rain, electrical storms, firestorms. Atmosphere is spontaneously flammable. Flora might be pale orange, rust-colored, or blue. <i>Highly Flammable, Unbreathable</i>.",
    "<i>Sulfur Dioxide</i>: Pale yellow sky, faint glows/refractive effects, sulfurous clouds. Possible day/night temp extremes, acid rain, sulfuric acid fog, volcanic activity, sulfur snow. Flora might be pale yellow, gray, white, or pale violet. <i>Corrosive, Unbreathable</i>.",
    "<i>Sulfur-Rich</i>: Red/brown sky, diffuse light, intense sunsets, sulfuric clouds. Possible extreme temp variation, sulfur rain, volcanic activity, sulfur dust storms, geothermal phenomena. Flora might be red, brown, or black. <i>Corrosive, Unbreathable</i>.",
    "<i>Xenon-Helium</i>: Soft blue/violet sky, tranquil, faint glows, gentle breezes, limited precipitation. Possible day/night temp extremes, electromagnetic phenomena. Flora might be soft blue, violet, silver, or pale orange. <i>Unbreathable</i>.",
  ],
  ...
  "oracle-village-type-result": [
    "<i>Subsistence</i>. Established in a locale where basic survival needs can be met.",
    "<i>Farming Village</i>. Produces surplus foodstuffs for export.",
    "<i>Mining Village</i>. Established to extract a valuable resource.",
    "<i>Crossroads</i>. Grown up at the intersection of two or more trade routes.",
    "<i>Religious site</i>. Established around a place of religious significance.",
  ],

  "oracle-town-type-result": [
    "<i>Residential center</i>. Designed to house population, with infrastructure and services dedicated to habitation, education, and daily necessities.",
    "<i>Industrial center</i>. Focused on manufacturing, production, and resource extraction, with factories, refineries, and processing facilities dominating the landscape.",
    "<i>Transportation center</i>. Dedicated to the movement of goods and people, featuring a major port, shipping terminals, transit routes, and/or rail systems, that connect multiple regions and/or worlds.",
    "<i>Commercial center</i>. Thrives on trade and services, with markets, businesses, and commerce driving its economy, acting as a hub for nearby settlements.",
    "<i>Academic center</i>. Devoted to educational and research institutions, with an economy and culture driven by universities, schools, and intellectual pursuits.", 
    "<i>Government center</i>. Centered around administrative and bureaucratic functions, housing key offices and personnel who manage the surrounding region or world’s political and civic duties.", 
  ],

  "oracle-residential-district-location-result": [
    "Residential street",
    "Apartment",
    "House/row house",
    "Park/playground",
  ...
  "oracle-residential-district-inhabitant-result": [
    "Commuter",
    "Student/child",
    "Retiree",
    "Homemaker",
  ...
  "oracle-slum-district-location-result": [
    "Shantytown",
    "Alleyway",
    "Tenement",
    "Camp/squat",
  ...
  "oracle-slum-district-inhabitant-result": [
    "Beggar/addict",
    "Street vendor",
    "Orphan/runaway",
    "Scavenger",
  ...
  "oracle-industrial-district-location-result": [
    "Factory",
    "Warehouse",
    "Loading dock",
    "Workshop",
    ...
    "Corporate office",
    "Chemical plant",
    "Transition to TRANSIT DISTRICT",
  ],

  "oracle-industrial-district-inhabitant-result": [
    "Factory worker",
    "Machine operator",
    "Driver",
    "Cargo handler",
  ...
  "oracle-transit-district-location-result": [
    "Rail station",
    "Vehicle lot/depot",
    "Overpass",
    "Vehicle rental",
    ...
    "Logistics center",
    "Control tower",
    "Transition to INDUSTRIAL DISTRICT",
  ],

  "oracle-transit-district-inhabitant-result": [
    "Driver",
    "Security/police",
    "Transit officer",
    "Conductor",
  ...
  "oracle-commercial-district-location-result": [
    "Shop/boutique",
    "Bar/café",
    "Restaurant",
    "Mall",
    ...
    "Theater/cinema",
    "Arena/stadium",
    "Transition to FINANCIAL DISTRICT",
  ],

  "oracle-commercial-district-inhabitant-result": [
    "Customer",
    "Salesperson",
    "Server/attendant",
    "Office worker",
  ...
  "oracle-financial-district-location-result": [
    "Office building",
    "Skyscraper",
    "Plaza",
    "Bank",
    ...
    "Stock exchange",
    "Corporate HQ",
    "Transition to COMMERCIAL DISTRICT",
  ],

  "oracle-financial-district-inhabitant-result": [
    "Office worker",
    "Security/police",
    "Accountant",
    "IT specialist",
  ...
  "oracle-religious-district-location-result": [
    "Residence/hostel",
    "Shrine/chapel",
    "Temple/church",
    "Graveyard",
  ...
  "oracle-religious-district-inhabitant-result": [
  "Devotee",
  "Pilgrim/tourist",
  "Monk/nun",
  "Priest/clergy",
  ...
  "oracle-academic-district-location-result": [
    "University/college",
    "Lecture hall",
    "Library",
    "Dormitory",
  ...
  "oracle-academic-district-inhabitant-result": [
  "Student",
  "Service worker",
  "Clerk/salesperson",
  "Administrator",
  ...
  "oracle-science-district-location-result": [
    "Clinic",
    "Hospital",
    "Pharmacy",
    "Outpatient facility",
  ...
  "oracle-science-district-inhabitant-result": [
    "Patient",
    "Nurse",
    "Doctor",
    "Researcher",
  ...
  "oracle-municipal-district-location-result": [
    "Public library",
    "Municipal park",
    "Assembly plaza",
    "Post office",
  ...
  "oracle-municipal-district-inhabitant-result": [
    "Civil servant",
    "Clerk",
    "Librarian",
    "Security/police",
