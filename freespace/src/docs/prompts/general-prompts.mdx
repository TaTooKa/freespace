...
## GATHER INFORMATION
⋗ **When you search for clues, conduct an investigation, analyze evidence, or do research,** test your <Stat name="INTELLECT"/>.
...
## USE YOUR GEAR
⋗ **When you check to see if you have a specific helpful item or resource**, as long as your RESOURCES is 1 or greater, you have it and are ready to use it (it gives _narrative permission_, improves _fictional positioning_ or gives a <span class="boost">BOOST</span> when used). 

Then subtract one point from your RESOURCES if the item is of a _one-time use_, or two if it should last for at least a couple of scenes.
...
## CLASH
⋗ **When you violently clash with one or more foes at close quarters,** test your <Stat name="PHYSIQUE"/>. **If you attack at a distance**, test your <Stat name="DEXTERITY"/>.
