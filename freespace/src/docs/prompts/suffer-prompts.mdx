...
Then, **if your GRIT is 0 or you choose to resist the harm**, test your <Stat name="PHYSIQUE"/>.
...
Then, **if your PSYCHE is 0 or you choose to resist the stress**, test your <Stat name="CHARISMA"/>.
...
## FACE DESOLATION
⋗ **When you are brought to the brink of desolation**, test your <Stat name="CHARISMA"/>.
