...
⋗ **When you face physical injury, fatigue, or illness**, suffer <span class="fuchsia bold">-1 HEALTH</span> for minor harm, <span class="fuchsia bold">-2 HEALTH</span> for serious harm, or <span class="fuchsia bold">-3 HEALTH</span> for major harm.

Then, **if your HEALTH is 0 or you choose to resist the harm**, test your <Stat name="PHYSIQUE"/>.
...
> If <span class="turquoise bold">CRITICAL</span>, also gain **+1 HEALTH**.
...
> If <span class="fuchsia bold">CRITICAL</span>, it’s worse than you thought. Suffer another **-1 HEALTH**.

Then, **if your HEALTH is still 0**, roll on the table below (if you are *IN A BAD SPOT* you gain a <span class="glitch" data-text="GLITCH">GLITCH</span> to this roll):
...
| 61-75 | You are dying. Within an hour or two, you must [HEAL](/prompts/recovery-prompts#heal) and raise your **HEALTH** above 0, or [FACE DEATH](/prompts/suffer-prompts#face-death). |
...
Then, **if your PSYCHE is 0 or you choose to resist the stress**, test your <Stat name="RESOLVE"/>.
...
## SACRIFICE RESOURCES
⋗ **When you lose or consume resources,** suffer <span class="fuchsia bold">-1 RESOURCES</span> for a minor loss, <span class="fuchsia bold">-2 RESOURCES</span> for a serious loss, or <span class="fuchsia bold">-3 RESOURCES</span> for a major loss.

> You cannot **SACRIFICE RESOURCES** with your RESOURCES at 0.
...
## FACE DEATH
⋗ **When you are brought to the brink of death**, test your <Stat name="PHYSIQUE"/>.
...
## FACE DESOLATION
⋗ **When you are brought to the brink of desolation**, test your <Stat name="RESOLVE"/>.
