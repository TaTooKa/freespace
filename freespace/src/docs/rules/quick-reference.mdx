...
- Set your **HEALTH**, **PSYCHE** and **RESOURCES** to 5.
- Choose your **CHARACTER ARC** from the options provided. Your **CHARACTER ARC** is the objective you want to accomplish before you [RETIRE](/prompts/fate-prompts#retire). You can flesh it out or give it more details in the *NOTES* section, if you want.
- Choose 3 [TRAITS](/character-traits) from the *SKILLS AND BACKGROUND* and *ITEMS AND GEAR* sections, and 1 from the *VEHICLE MODULES* section.
...
## BEGINNING A GAME
- All players involved should envision and/or discuss the *space sci-fi setting* they’ll be exploring in the fiction (available tech, major factions and opposition, background story framing, characteristics of the local sector, etc).

> The players should create their characters together and decide what they do and why they are together, working as a team.

- Each character has their own objectives, defined by their **CHARACTER ARC**, and that’s what each of them should be pursuing (they can decide to directly help each other or not). The **CHARACTER ARC** works as an *EPIC challenge*, meaning that it will take lots of attempts for each character to progress and eventually fulfill it.  Once all of that’s clear, envision an inciting incident, [ACCEPT A CHALLENGE](/prompts/challenge-prompts#accept-a-challenge) and get to work on it.
<br/>
