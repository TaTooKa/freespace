...
When required to test a **STAT** (<span class="stat">INTELLECT, PHYSIQUE, DEXTERITY, CHARISMA </span><span>or</span> <span class="stat">SUBTERFUGE</span>), roll d100 against that value. If equal or under, it’s a <span class="turquoise bold">SUCCESS</span>. If over that value, it’s a <span class="fuchsia bold">FAILURE</span>.
